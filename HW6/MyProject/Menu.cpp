...
void Menu::render(ShaderProgram* program)
{
    ...
    Utility::draw_text(program, text_texture_id, "Cave", 1.3f, 0.1f, glm::vec3(7.9f, -3.3f, 0.0f));
    Utility::draw_text(program, text_texture_id, "Action", 1.3f, 0.1f, glm::vec3(6.6f, -4.5f, 0.0f));
}